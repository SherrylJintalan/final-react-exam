...
export default function AddProductPage() {
    ...
    return (
        <div className="container mx-auto p-8 max-w-2xl bg-white rounded-xl shadow-2xl mt-10">
            <h1 className="text-3xl font-extrabold text-blue-600 mb-6 border-b pb-3">
                Add a New Product
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    className="w-full py-3 bg-blue-600 text-white font-bold rounded-lg shadow-xl hover:bg-blue-700 transition-colors transform hover:scale-[1.01]"
                >
