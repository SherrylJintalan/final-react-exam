	...
	return (
		<>
			<div className="container mx-auto p-4 max-w-9xl pb-28">
				<h1 className="text-4xl font-extrabold text-white mb-1">Product Management App</h1>
				...
				<div className="text-center p-6 border-2 border-dashed border-gray-300 rounded-xl bg-gray-50 mb-5">
					...
					<Link href="/add-product" className="py-3 px-8 bg-blue-500 text-white font-bold rounded-lg shadow-lg hover:bg-blue-600 transition-colors transform hover:scale-[1.02]">
