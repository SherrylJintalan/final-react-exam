...
export default function CartPage() {
		...
		return (
			<div className="container mx-auto p-8 max-w-4xl text-center">
				...
				<Link href="/" legacyBehavior>
					<a className="py-3 px-6 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-colors">
						Go Back Shopping
					</a>
				</Link>
			</div>
	...
	return (
		<div className="container mx-auto p-4 max-w-7xl">
			<h1 className="text-4xl font-extrabold text-black mb-8">Shopping Cart ({totalCartItems} Items)</h1>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
				...
				<div className="lg:col-span-1 p-6 bg-white rounded-xl shadow-2xl border border-gray-100 sticky top-4 h-fit">
					...
					<button 
						...
						className="w-full mt-6 py-3 bg-blue-600 text-white font-bold rounded-lg shadow-xl hover:bg-blue-700 transition-colors"
					>
						Proceed to Checkout
					</button>
				</div>
